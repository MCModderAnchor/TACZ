    ...
    public void onProjectileHit(Entity entity, EntityHitResult result, DamageSource source, float damage) {
        ...
        if (sourceEntity instanceof Player player) {
            ...
            if (entity instanceof EntityKineticBullet projectile) {
                ...
                MinecraftForge.EVENT_BUS.post(new EntityHurtByGunEvent.Post(projectile, this, player, projectile.getGunId(), projectile.getGunDisplayId(), damage, isHeadshot, headshotMultiplier, LogicalSide.SERVER));
