...
public final class GunPropertyDiagrams {
    ...
    public static void draw(GunRefitScreen screen, PoseStack poseStack, Font font, int x, int y) {
        ...
        TimelessAPI.getCommonGunIndex(gunId).ifPresent(index -> {
            ...
            font.draw(poseStack, fireModeText, nameTextStartX+12, yOffset[0], fontColor);
            ...
            font.draw(poseStack, Component.translatable("gui.tacz.gun_refit.property_diagrams.ammo_capacity"), nameTextStartX, yOffset[0], fontColor);
            ...
            font.draw(poseStack, Component.translatable("gui.tacz.gun_refit.property_diagrams.sprint_time"), nameTextStartX, yOffset[0], fontColor);
            Screen.fill(poseStack, barStartX, yOffset[0] + 2, barEndX, yOffset[0] + 6, barBackgroundColor);
