...
public final class GunPropertyDiagrams {
    public static void draw(GunRefitScreen screen, PoseStack poseStack, Font font, int x, int y) {
        ...
        TimelessAPI.getCommonGunIndex(gunId).ifPresent(index -> {
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.damage"), nameTextStartX, y + pitch, fontColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.rpm"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.accuracy"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.hipfire_inaccuracy"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.ammo_capacity"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.yaw"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.pitch"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.ads"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
            ...
            font.draw(poseStack, new TranslatableComponent("gui.tacz.gun_refit.property_diagrams.sprint_time"), nameTextStartX, y + pitch, fontColor);
            Screen.fill(poseStack, barStartX, y + pitch + 2, barEndX, y + pitch + 6, barBackgroundColor);
