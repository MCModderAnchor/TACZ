...
public class ParticleFactoryRegistry {
    ...
    public static void onRegisterParticleFactory(ParticleFactoryRegisterEvent event) {
        ...
        particleEngine.register(ModParticles.BULLET_HOLE.get(), (typeIn, worldIn, x, y, z, xSpeed, ySpeed, zSpeed) -> new BulletHoleParticle(worldIn, x, y, z, typeIn.getDirection(), typeIn.getPos(), typeIn.getAmmoId(), typeIn.getGunId()));
    }
}