        ...
        public void initComponents() {
            ...
            if (value != null) {
                ...
                if (distance > defaultDistance) {
                    components.add(new TranslatableComponent("tooltip.tacz.attachment.sound_distance.increase").withStyle(ChatFormatting.RED));
                } else if (distance < defaultDistance) {
                    components.add(new TranslatableComponent("tooltip.tacz.attachment.sound_distance.increase").withStyle(ChatFormatting.GREEN));
                }
                if (value.right()) {
                    components.add(new TranslatableComponent("tooltip.tacz.attachment.silence").withStyle(ChatFormatting.GREEN));
                }
            }
        }
    }
