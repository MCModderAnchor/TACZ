package com.tac.guns.client.gui.compat;
...
public class ClothConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.message = MultiLineLabel.create(this.font, new TranslatableComponent("gui.tac.cloth_config_warning.tips"), 300);

        this.addRenderableWidget(new Button(posX, posY - 15, 200, 20, new TranslatableComponent("gui.tac.cloth_config_warning.download"), b -> openUrl(CLOTH_CONFIG_URL)));
