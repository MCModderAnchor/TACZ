...
public enum BedrockAssetManager {
    ...
    private final Map<ResourceLocation, AnimationController> animations = Maps.newHashMap();
    ...
    public void addAnimation(ResourceLocation registryName, AnimationController animation){
        animations.put(registryName, animation);
    }

    public AnimationController getAnimation(ResourceLocation registryName){
